...
window.$$note = [
  ...
  { 
    ...
    text:`正好我这两天看了vue的官方文档面试的时候问了很多，感觉他会的东西不多基础也不好，然后面试就凉了，现实，就是这麽的残酷，我也要更加好好学，不然可能我就会成为坐在对面的那个人`
  },
  {
    title:'你还是那个说谎会脸红的少年',
    createdTime:'2021-5-5',
    text:`当今天老板问我演唱会有没有录视频的时候，我算是坦白了吧，我回答说没去有其他事情，然后老板问我票怎么弄的，卖了啊，第一遍我没回答，第二遍我低声回答了一声嗯，然后感觉老脸通红`
  },
  {
    title:'工作两个月感悟',
    createdTime:'2021-5-4',
    text: `3.4号我加入xxx公司，刚开始的一个月每天都很努力，也始终对一切保持着积极的态度。在公司高强度(可能是我技术太菜)的条件下，
      我学习到了很多东西，例如：用更加灵活的快捷键，使用utils工具，做项目笔记来提升开发效率。在这两个月的时间里，我大大小小参与了有
      7个项目 1、相如攻防演练(demo),2、巡检车桌面端设置页面开发、3、网安盒子(部分页面开发)、4、广东停车盒子、5、智慧舆情用户端、管理端(更新维护),
      6、巡检车手机端FLutter开发、7、动态面板展示(一天弄完，算是个demo); 刚开始公司对我印象还好，但是慢慢的，每天加班加到10点左右，一个任务还没有做完，
      就会有另外一个任务去做，可能就是我比别的实习生工资高1000块钱的原因吧。在公司干了两个月感觉身体也很受损伤，现在就是很容易就劳累。以后要注意身体，毕竟身体才是最重要的，
      在这里我也体会到了什么是资本家的丑恶和吝啬鬼的可耻。他只在乎严重的利益,无论你是谁，他会对你进行无情的压榨。一位同事引用的一句话非常好
      “谈笑间，樯橹灰飞烟灭”,和资本家谈话一定要坚定自己的立场，一定要坚定自己的立场，一定要坚定自己的立场。要勇于反抗，不然他们只会更加肆无忌惮。
      在这两个月里,感觉自己的技术增长的并不是很明显，虽然知道了很多东西，但是学到的都只是一些皮毛，还有就是前端时间真的太浮躁了，这段时间在慢慢的静下来，趁着这段时间好好深入
      学习一些东西。养成好习惯。
    `
  },
  {
